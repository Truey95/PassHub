...
namespace defuse\cryptocompatibility;

use Defuse\CryptoCompatibility\Exception as Ex;

/*
 * We want to catch all uncaught exceptions that come from the CryptoCompatibility class,
